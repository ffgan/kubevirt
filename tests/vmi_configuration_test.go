...
var _ = Describe("[sig-compute]Configurations", decorators.SigCompute, func() {
	...
	Context("[rfe_id:2869][crit:medium][vendor:cnv-qe@redhat.com][level:component]with machine type settings", Serial, func() {
		...
		BeforeEach(func() {
			...
			config := kv.Spec.Configuration
			config.MachineType = ""
			config.ArchitectureConfiguration = &v1.ArchConfiguration{Amd64: &v1.ArchSpecificConfiguration{}, Arm64: &v1.ArchSpecificConfiguration{}, Riscv64: &v1.ArchSpecificConfiguration{}, S390x: &v1.ArchSpecificConfiguration{}}
			...
			config.ArchitectureConfiguration.Riscv64.EmulatedMachines = testEmulatedMachines
		...
		It("[test_id:3126]should set machine type from kubevirt-config", Serial, func() {
			...
			config.ArchitectureConfiguration.Riscv64.MachineType = "pc"
