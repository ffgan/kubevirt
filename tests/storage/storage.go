...
var _ = Describe(SIG("Storage", func() {
	...
	Describe("Starting a VirtualMachineInstance", func() {
		...
		Context("[rfe_id:2288][crit:high][vendor:cnv-qe@redhat.com][level:component] With not existing PVC", decorators.WgS390x, decorators.WgArm64, decorators.WgRiscv64, func() {
		...
		Context("write and read data from a shared disk", func() {
			It("should successfully write and read data", decorators.RequiresBlockStorage, func() {
				...
				libstorage.CreateBlankBlockDataVolume(pvcClaim, testsuite.GetTestNamespace(vmi1), "500Mi")
